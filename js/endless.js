...
// Max Pokémon ID allowed per stage.
const STAGE_MAX_GEN_ID = [0, 151, 251, 386, 493, 649, 721, 809, 905, 1025];
function getEndlessMaxGenId(stageNum) {
  return STAGE_MAX_GEN_ID[Math.min(stageNum, STAGE_MAX_GEN_ID.length - 1)];
}
...
const ENDLESS_ARCHETYPES = [
  ...
  { id: 'stage6_boss', name: 'Diantha', type: null, sprite: 'aceTrainer',
    pool: [701,699,706,711,715,700] },
  { id: 'stage7_boss', name: 'Professor Kukui', type: null, sprite: 'aceTrainer',
    pool: [745,738,760,784,791,800] },
  { id: 'stage8_boss', name: 'Leon', type: null, sprite: 'aceTrainer',
    pool: [812,815,818,887,884,890] },
  { id: 'stage9_boss', name: 'Nemona', type: null, sprite: 'aceTrainer',
    pool: [908,911,914,937,956,1000] },
...
const STAGE_BOSS_ARCHETYPE = [
  '',
  'stage1_boss', 'stage2_boss', 'stage3_boss', 'stage4_boss',
  'stage5_boss', 'stage6_boss', 'stage7_boss', 'stage8_boss', 'stage9_boss',
];
...
const FIXED_STAGE_REGIONS = {
  ...
  6: [
    [ // Region 1
      { name: 'Viola',   type: 'Bug',      sprite: 'viola',   ids: [664, 665, 666] },
      { name: 'Grant',   type: 'Rock',     sprite: 'grant',   ids: [696, 698, 697, 699] },
      { name: 'Korrina', type: 'Fighting', sprite: 'korrina', ids: [674, 675, 701, 652] },
    ],
    [ // Region 2
      { name: 'Ramos',   type: 'Grass',    sprite: 'ramos',   ids: [672, 673, 708, 709, 651] },
      { name: 'Clemont', type: 'Electric', sprite: 'clemont', ids: [702, 694, 695, 707, 658] },
      { name: 'Valerie', type: 'Fairy',    sprite: 'valerie', ids: [669, 670, 671, 682, 683, 700] },
    ],
    [ // Region 3
      { name: 'Wulfric',  type: 'Ice',       sprite: 'wulfric',  ids: [712, 713, 698, 699, 715, 713], levelBonus: 2 },
      { name: 'Lysandre', type: 'Fire/Dark', sprite: 'lysandre', ids: [668, 687, 663, 675, 697, 721], extraLevels: { 5: 8 }, traitBonus: 1 },
      { name: 'Diantha',  type: null,        sprite: 'diantha',  ids: [701, 699, 706, 711, 715, 700], levelBonus: 12, traitBonus: 1 },
    ],
  ],
  7: [
    [ // Region 1
      { name: 'Hala',   type: 'Fighting', sprite: 'hala',   ids: [739, 740, 766, 794] },
      { name: 'Olivia', type: 'Rock',     sprite: 'olivia', ids: [744, 745, 774, 805] },
      { name: 'Mallow', type: 'Grass',    sprite: 'mallow', ids: [753, 754, 755, 756, 763] },
    ],
    [ // Region 2
      { name: 'Sophocles', type: 'Electric/Steel', sprite: 'sophocles', ids: [777, 737, 738, 796, 801] },
      { name: 'Acerola',   type: 'Ghost/Fairy',    sprite: 'acerola',   ids: [769, 770, 778, 802, 785] },
      { name: 'Guzma',     type: 'Bug',            sprite: 'guzma',     ids: [767, 768, 738, 752, 794, 795], traitBonus: 1 },
    ],
    [ // Region 3
      { name: 'Nanu',     type: 'Dark',    sprite: 'nanu',     ids: [744, 745, 757, 758, 799, 802] },
      { name: 'Lusamine', type: 'Psychic', sprite: 'lusamine', ids: [760, 763, 771, 793, 795, 786], extraLevels: { 5: 8 }, traitBonus: 1 },
      { name: 'Professor Kukui', type: null, sprite: 'kukui', ids: [745, 738, 760, 784, 791, 800], levelBonus: 13, traitBonus: 1 },
    ],
  ],
  8: [
    [ // Region 1
      { name: 'Milo',  type: 'Grass', sprite: 'milo',  ids: [829, 830, 840, 841, 842] },
      { name: 'Nessa', type: 'Water', sprite: 'nessa', ids: [846, 847, 833, 834, 882] },
      { name: 'Kabu',  type: 'Fire',  sprite: 'kabu',  ids: [850, 851, 852, 853, 815] },
    ],
    [ // Region 2
      { name: 'Bea',   type: 'Fighting',   sprite: 'bea',   ids: [852, 853, 865, 870, 889] },
      { name: 'Opal',  type: 'Fairy',      sprite: 'opal',  ids: [859, 860, 861, 868, 869, 858] },
      { name: 'Piers', type: 'Dark/Poison', sprite: 'piers', ids: [862, 859, 860, 861, 877, 890], traitBonus: 1 },
    ],
    [ // Region 3
      { name: 'Raihan', type: 'Dragon/Steel', sprite: 'raihan', ids: [884, 887, 880, 882, 884, 895], extraLevels: { 5: 8 } },
      { name: 'Rose',   type: 'Steel',        sprite: 'rose',   ids: [879, 884, 863, 869, 809, 894], levelBonus: 5, traitBonus: 2 },
      { name: 'Leon',   type: null,           sprite: 'leon',   ids: [812, 815, 818, 887, 884, 890], levelBonus: 15, extraLevels: { 5: 10 }, copyPlayerTraits: true },
    ],
  ],
  9: [
    [ // Region 1
      { name: 'Katy',    type: 'Bug',      sprite: 'katy',    ids: [917, 918, 919, 920, 953] },
      { name: 'Brassius', type: 'Grass',   sprite: 'brassius', ids: [906, 907, 928, 929, 930] },
      { name: 'Iono',    type: 'Electric', sprite: 'iono',    ids: [921, 922, 923, 938, 939] },
    ],
    [ // Region 2
      { name: 'Kofu',   type: 'Water',  sprite: 'kofu',   ids: [912, 913, 960, 961, 976] },
      { name: 'Ryme',   type: 'Ghost',  sprite: 'ryme',   ids: [971, 972, 979, 987, 998] },
      { name: 'Tulip',  type: 'Psychic', sprite: 'tulip', ids: [955, 956, 981, 985, 1001, 1002], traitBonus: 1 },
    ],
    [ // Region 3
      { name: 'Grusha', type: 'Ice',    sprite: 'grusha', ids: [974, 975, 996, 997, 998, 1003], levelBonus: 4 },
      { name: 'Geeta',  type: null,     sprite: 'geeta',  ids: [976, 983, 959, 1000, 998, 970], levelBonus: 8, traitBonus: 1 },
      { name: 'Nemona', type: null,     sprite: 'nemona', ids: [908, 911, 914, 937, 956, 1000], levelBonus: 16, extraLevels: { 5: 10 }, copyPlayerTraits: true },
    ],
  ],
};
...
function rollRegion(stageNum, regionNum) {
  ...
  // Region 3 big boss: use stage-specific boss for defined stages, elite_alltype after that.
  ...
  // Stage bosses skip gen and legendary filters (hand-curated pools).
  const isStageBoss = isFinalRegion && !!STAGE_BOSS_ARCHETYPE[stageNum];
