...
function getTrainerSpritePath(key, isGen2) {
  if (isGen2 && GEN2_SPRITE_FILENAME[key]) {
    return `https://pokelike.xyz/sprites/gen2/${GEN2_SPRITE_FILENAME[key]}.png`;
  }
  return `https://pokelike.xyz/sprites/${key}.png`;
}
...
const RANDOM_TRAINER_SPRITES = TRAINER_SPRITE_KEYS.map(k => `https://pokelike.xyz/sprites/${k}.png`);
...
const JOHTO_GYM_LEADER_SPRITES = [
  'https://pokelike.xyz/sprites/gen2/falkner.png',
  'https://pokelike.xyz/sprites/gen2/bugsy.png',
  'https://pokelike.xyz/sprites/gen2/whitney.png',
  'https://pokelike.xyz/sprites/gen2/morty.png',
  'https://pokelike.xyz/sprites/gen2/chuck.png',
  'https://pokelike.xyz/sprites/gen2/jasmine.png',
  'https://pokelike.xyz/sprites/gen2/pryce.png',
  'https://pokelike.xyz/sprites/gen2/clair.png',
];
...
function getNodeSprite(node) {
  ...
  const ICON_SPRITES = {
    [NODE_TYPES.BATTLE]:    gen2 ? 'https://pokelike.xyz/sprites/gen2/grass.png'    : 'https://pokelike.xyz/sprites/grass.png',
    [NODE_TYPES.CATCH]:     gen2 ? 'https://pokelike.xyz/sprites/gen2/pokeball.png' : 'https://pokelike.xyz/sprites/catchPokemon.png',
    [NODE_TYPES.ITEM]:      'https://pokelike.xyz/sprites/itemIcon.png',
    [NODE_TYPES.TRADE]:      'https://pokelike.xyz/sprites/tradeIcon.png',
    [NODE_TYPES.LEGENDARY]:  'https://pokelike.xyz/sprites/legendaryEncounter.png',
    [NODE_TYPES.QUESTION]:   'https://pokelike.xyz/sprites/questionMark.png',
    [NODE_TYPES.POKECENTER]: 'https://pokelike.xyz/sprites/Poke Center.png',
    [NODE_TYPES.MOVE_TUTOR]: 'https://pokelike.xyz/sprites/moveTutor.png',
  };
  ...
  if (node.type === NODE_TYPES.BOSS) {
    if (typeof state !== 'undefined' && state.isEndlessMode) return 'https://pokelike.xyz/sprites/misteryTrainer.png';
    ...
    if (typeof state !== 'undefined' && state.gen2Mode) {
      ...
      if (mi === 8)  return 'https://pokelike.xyz/sprites/gen2/lance.png';
    ...
    return 'https://pokelike.xyz/sprites/champ.png';
  }
  if (node.type === NODE_TYPES.SILVER) return 'https://pokelike.xyz/sprites/gen2/silver.png';
  return null;
}
